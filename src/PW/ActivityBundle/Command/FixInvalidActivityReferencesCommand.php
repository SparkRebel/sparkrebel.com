...
class FixInvalidActivityReferencesCommand extends DoctrineODMCommand
{
    /**
     * @var \MongoCollection
     */
    ...
    {
        $this
            ->setName('activity:find-invalid-references')
    ...
    protected function initialize(InputInterface $input, OutputInterface $output)
    {
         ...
         $this->activitiesCollection = $this->getMongoCollectionForClass('PW\ActivityBundle\Document\Activity');
    ...
    {
        $cursor = $collection->find(array('target.$ref' => 'follows'), array('target.$id' => 1));
        $numProcessed = 0;
    ...
    {
        $this->activitiesCollection->remove(array('_id' => $id));
    }
