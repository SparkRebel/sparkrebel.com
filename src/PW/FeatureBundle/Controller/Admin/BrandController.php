...
class BrandController extends Controller
{
     ...
     * @Route("/admin/feature/brand", name="admin_feature_brand_index")
     * @Template
     */
     ...
     * @Method("POST")
     * @Secure(roles="ROLE_ADMIN")
     * @Route("/admin/feature/brand/edit", name="admin_feature_brand_edit")
     * @Template
     */
     ...
     * @Method("POST")
     * @Secure(roles="ROLE_ADMIN")
     * @Route("/admin/feature/brand/delete/{id}", name="admin_feature_brand_delete")
     * @Template
     */
     ...
     * @Method("GET")
     * @Secure(roles="ROLE_ADMIN")
     * @Route("/admin/feature/brand/templates")
     * @Template
     */
