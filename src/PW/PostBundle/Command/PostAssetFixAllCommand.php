...
class PostAssetFixAllCommand extends AbstractCommand
{
    ...
    {
        $this
            ->setName('post:asset:fix-all')
            ->setDescription('Fixe all post asset from original source')
            ->setDefinition(array(                
            ));
    }
